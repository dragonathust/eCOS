...
// Description:
// Usage   		:#include <cyg/io/config_keys.h>
//####DESCRIPTIONEND####
//
// ====================================================================
...
#define CYG_IO_SET_CONFIG_SERIAL_DEFAULT			   0x0190	 // set serial configure to the default
#define CYG_IO_SET_CONFIG_SERIAL_BAUD_RATE			   0x0191	 // set serial burad rate
...
#define CYG_IO_SET_CONFIG_TTY_INFO_DEFAULT 0x282 // Set channel configuration to default
...
#define CYG_IO_GET_CONFIG_FLASH_STATUS           0x608
...
#define CYG_IO_SET_CONFIG_DISK_IN				 0x701
#define CYG_IO_SET_CONFIG_DISK_OUT				 0x702	
#define CYG_IO_SET_CONFIG_DISK_TYPE_USB			 0x703
#define CYG_IO_SET_CONFIG_DISK_TYPE_SD			 0x704
#define CYG_IO_SET_CONFIG_DISK_TYPE_CF			 0x705

#define CYG_IO_SET_CONFIG_FS_TYPE_FATFS			 0x710
#define CYG_IO_SET_CONFIG_FS_TYPE_NTFS			 0x711
#define CYG_IO_SET_CONFIG_FS_TYPE_JFFS2			 0x712		 
#define CYG_IO_SET_CONFIG_FS_TYPE_YAFFS          0x713
#define CYG_IO_SET_CONFIG_FS_TYPE_CDFS           0x714
#define CYG_IO_SET_CONFIG_FS_TYPE_EXT2_EXT3      0X715
#define CYG_IO_SET_CONFIG_FS_TYPE_LINUX_SWAP     0X716

#define CYG_IO_GET_CONFIG_DISK_CAPACITY          0x730
...
#define CYG_IO_GET_FILE_POSTION        			0x1091
#define CYG_IO_GET_FILE_ATTRIBUTE				0x1092
#define CYG_IO_SET_FILE_ATTRIBUTE				0x1093
#define CYG_IO_SET_FILE_TIME					0x1094
