...
#define BOTTOM_FORWARD             0x1
#define TOP_FORWARD                0x10
...
typedef int cyg_flash_printk(const char *fmt, ...);
__externC int cyg_flash_init( cyg_flash_printk *pf );
__externC int cyg_flash_set_printk(const cyg_flashaddr_t flash_base,
                                   cyg_flash_printk *pf);
__externC int cyg_flash_status(const cyg_flashaddr_t flash_base, size_t len, cyg_uint32 *status);
__externC int cyg_flash_mode(const cyg_flashaddr_t flash_base, size_t len, cyg_uint8 *mode);
__externC int cyg_flash_protect_addr(const cyg_flashaddr_t flash_base, size_t len,  cyg_uint32 *protect_addr);

__externC void cyg_flash_set_global_printk(cyg_flash_printk *pf);
...
typedef int _printk(const char *fmt, ...);

externC int flash_init(_printk *pf);
